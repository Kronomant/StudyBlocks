const AVAILABLE_WEEK_DAYS = ['Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sabado'];
...
// App methods
    ...
    drawEvents() {
        ...
        let eventList = this.eventList[calendar.active.formatted] || ['Não existe nenhum evento hoje'];
        let eventTemplate = "";
    ...
    drawMonths() {
        let availableMonths = ["Jan", "Feb", "Mar", "Abr", "Mai", "Jun", "Jul", "Ago", "Set", "Out", "Nov", "Dez"];
        let monthTemplate = "";
        let calendar = this.getCalendar();
